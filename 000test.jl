...
# Suggested setup for low / high carrying capacity scenario:
#    Basin volume: 5000 / 500
#    Initial nr. males: 500 / 2000
#    Initial nr. females: 500 / 2000
#    Xmax: 230 / 11500 *
#    chemostat? OFF
#    hermaphrodite? OFF

modello = model_initialize(15000.0, 30000.0, 7500.0, 0.0, 50000.0, 1.0, 110.0)
...
for i in 1:num_runs
    ...
    # Run the model
    df_agent = run!(modello, sardine_step!, evolve_environment!,365*30; adata, mdata)
